...
```{r Upper and lower limits, fig.cap="Alcohol consumption per capita + error"}
alcohol_country %>% 
  filter(alcohol_country$GEO_NAME_SHORT == country) %>%
...
```{r Error bars, fig.cap="Alcohol consumption per capita + error bars"}
alcohol_country %>% 
  filter(alcohol_country$GEO_NAME_SHORT == country) %>%
  ggplot(aes(x=DIM_TIME)) +
...
```{r Error ribbon, fig.cap="Alcohol consumption per capita + error ribbon"}
alcohol_country %>% 
  filter(alcohol_country$GEO_NAME_SHORT == country) %>%
